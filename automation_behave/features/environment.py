...
from automation_behave.helpers.sut import Sut
from automation_behave.utilites.env import Env

print(os.getcwd())
with open('./automation_behave/helpers/log_config.yaml', 'r') as f:
...
def before_all(context):
    ...
    time.sleep(5)
    os.system(
        "docker run -d --link selenium-hub:hub -p 6901:5900 --name "
        "selenium-node-firefox "
        " selenium/node-firefox-debug")
    os.system(
        "docker run -d --link selenium-hub:hub -p 6900:5900 --name "
